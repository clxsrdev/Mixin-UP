    ...
    var body: some View {
        ...
        ZStack{
            ...
            withAnimation (.default){
                CongratsView(level1View: $level2View, level2View: $level2View, level3View: $level2View, level4View: $level2View, level5View: $level2View, level6View: $level2View, level7View: $level2View, level8View: $level2View, level9View: $level2View, finalView: $level2View, congratsView: $congratsView)
...
struct Level2View_Previews: PreviewProvider {
    static var previews: some View {
        ...
        return Level2View(level2View: level2View.projectedValue)    }
}
