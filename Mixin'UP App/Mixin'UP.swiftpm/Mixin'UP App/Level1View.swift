...
struct Level1View: View {
    ...
    @State var startingOffsetYA: CGFloat = UIScreen.main.bounds.height * 1.38
    ...
    @State var startingOffsetYW: CGFloat = UIScreen.main.bounds.height * 1.38
    ...
    @State var startingOffsetYD: CGFloat = UIScreen.main.bounds.height * 1.38
    @State var currentDragOffsetYD: CGFloat = 0
    @State var startingOffsetXD: CGFloat = UIScreen.main.bounds.width * 1.25
    ...
    var body: some View {
        ...
        ZStack{
            ...
            VStack (spacing: 40){
                ...
                ZStack {
                    RoundedRectangle(cornerRadius: 70)
                        .fill(Color(UIColor(red: 0.20, green: 0.71, blue: 0.08, alpha: 1.00)))                        .frame(width: .infinity, height: 600)
                        .padding(.leading, 60)
                        .padding(.trailing, 60)
                ...
                ZStack{
                    ZStack{
                        RoundedRectangle(cornerRadius: 30)
                            .fill(Color(UIColor(red: 0.20, green: 0.71, blue: 0.08, alpha: 1.00)))
                    ...
                    ZStack{
                        RoundedRectangle(cornerRadius: 30)
                            .fill(Color(UIColor(red: 0.20, green: 0.71, blue: 0.08, alpha: 1.00)))                            .frame(width: 150, height: 140)
            ...
            withAnimation (.default){
                CongratsView(level1View: $level1View, level2View: $level1View, level3View: $level1View, level4View: $level1View, level5View: $level1View, level6View: $level1View, level7View: $level1View, level8View: $level1View, level9View: $level1View, finalView: $level1View, congratsView: $congratsView)
                    .offset(y: congratsView ? 0 : UIScreen.main.bounds.height + 500)
            }
            
        }.frame(maxWidth: .infinity, maxHeight: .infinity)
            .background(Color(UIColor(red: 0.12, green: 0.27, blue: 0.16, alpha: 1.00)))
...
struct Level1View_Previews: PreviewProvider {
    static var previews: some View {
        ...
        return Level1View(level1View: level1View.projectedValue)
    }
}
