    ...
    var body: some View {
        ...
        ZStack{
            ...
            VStack (spacing: 40){
                ...
                ZStack {
                    RoundedRectangle(cornerRadius: 70)
                        .fill(Color(UIColor(red: 0.11, green: 0.70, blue: 0.92, alpha: 1.00)))
                ...
                HStack {
                    ...
                    ZStack{
                        RoundedRectangle(cornerRadius: 30)
                            .fill(Color(UIColor(red: 0.11, green: 0.70, blue: 0.92, alpha: 1.00)))                            .frame(width: 150, height: 140)
            ...
            withAnimation (.default){
                CongratsView(level1View: $level4View, level2View: $level4View, level3View: $level4View, level4View: $level4View, level5View: $level4View, level6View: $level4View, level7View: $level4View, level8View: $level4View, level9View: $level4View, finalView: $level4View, congratsView: $congratsView)
                    .offset(y: congratsView ? 0 : UIScreen.main.bounds.height + 500)
            }
            
        }.frame(maxWidth: .infinity, maxHeight: .infinity)
        .background(Color(UIColor(red: 0.04, green: 0.25, blue: 0.39, alpha: 1.00)))
...
struct Level4View_Previews: PreviewProvider {
    static var previews: some View {
        ...
        return Level4View(level4View: level4View.projectedValue)    }
}
