    ...
    var body: some View {
        ZStack{
            ...
            withAnimation (.default){
                CongratsView(level1View: $level7View, level2View: $level7View, level3View: $level7View, level4View: $level7View, level5View: $level7View, level6View: $level7View, level7View: $level7View, level8View: $level7View, level9View: $level7View, finalView: $level7View, congratsView: $congratsView)
...
struct Level7View_Previews: PreviewProvider {
    static var previews: some View {
        ...
        return Level7View(level7View: level7View.projectedValue)    }
}
