    ...
    var body: some View {
        ...
        ZStack{
            ...
            withAnimation (.default){
                CongratsView(level1View: $level6View, level2View: $level6View, level3View: $level6View, level4View: $level6View, level5View: $level6View, level6View: $level6View, level7View: $level6View, level8View: $level6View, level9View: $level6View, finalView: $level6View, congratsView: $congratsView)
...
struct Level6View_Previews: PreviewProvider {
    static var previews: some View {
        ...
        return Level6View(level6View: level6View.projectedValue)    }
}
