    ...
    var body: some View {
        ...
        ZStack{
            ...
            withAnimation (.default){
                CongratsView(level1View: $level5View, level2View: $level5View, level3View: $level5View, level4View: $level5View, level5View: $level5View, level6View: $level5View, level7View: $level5View, level8View: $level5View, level9View: $level5View, finalView: $level5View, congratsView: $congratsView)
...
struct Level5View_Previews: PreviewProvider {
    static var previews: some View {
        ...
        return Level5View(level5View: level5View.projectedValue)    }
}
