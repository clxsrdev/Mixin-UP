    ...
    var body: some View {
        ZStack{
            ...
            VStack (spacing: 40){
                        ...
                        ZStack {
                            RoundedRectangle(cornerRadius: 70)
                                .fill(Color(UIColor(red: 0.94, green: 0.23, blue: 0.23, alpha: 1.00)))
            ...
            withAnimation (.default){
                CongratsView(level1View: $finalView, level2View: $finalView, level3View: $finalView, level4View: $finalView, level5View: $finalView, level6View: $finalView, level7View: $finalView, level8View: $finalView, level9View: $finalView, finalView: $finalView, congratsView: $congratsView)
                    .offset(y: congratsView ? 0 : UIScreen.main.bounds.height + 500)
            }
            
        }.frame(maxWidth: .infinity, maxHeight: .infinity)
            .background(Color(UIColor(red: 0.44, green: 0.05, blue: 0.05, alpha: 1.00)))
...
struct FinalLevelView_Previews: PreviewProvider {
    static var previews: some View {
        let finalView = State(initialValue: false)
        return FinalLevelView(finalView: finalView.projectedValue)
    }
}
