    ...
    var body: some View {
        ...
        ZStack{
            ...
            withAnimation (.default){
                CongratsView(level1View: $level3View, level2View: $level3View, level3View: $level3View, level4View: $level3View, level5View: $level3View, level6View: $level3View, level7View: $level3View, level8View: $level3View, level9View: $level3View, finalView: $level3View, congratsView: $congratsView)
...
struct Level3View_Previews: PreviewProvider {
    static var previews: some View {
        ...
        return Level3View(level3View: level3View.projectedValue)    }
}
