    ...
    var body: some View {
        ZStack{
            ...
            withAnimation (.default){
                CongratsView(level1View: $level9View, level2View: $level9View, level3View: $level9View, level4View: $level9View, level5View: $level9View, level6View: $level9View, level7View: $level9View, level8View: $level9View, level9View: $level9View, finalView: $level9View, congratsView: $congratsView)
...
struct Level9View_Previews: PreviewProvider {
    static var previews: some View {
        ...
        return Level9View(level9View: level9View.projectedValue)
    }
}
